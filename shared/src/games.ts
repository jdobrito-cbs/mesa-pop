...
export const GAME_CATALOG: GameDef[] = [
  ...
  { slug: 'magnata', name: 'Magnata (Bob Magnata)', description: 'Compre ruas do Brasil, cobre aluguel e quebre os rivais — com cartão de crédito! Até 6 ou contra o robô.', family: 'TURN', minPlayers: 2, maxPlayers: 6, color: 'pop-green', icon: '🏙️', phase: 9, enabled: true },
  { slug: 'tio-mario-milionario', name: 'Milionário (Tio Mário Milionário)', description: 'Suba a escada de 16 perguntas até POP$ 1 MILHÃO — pare na hora certa ou perca metade! Cartas, universitários, plateia e 3 pulos.', family: 'PUZZLE', minPlayers: 1, maxPlayers: 1, color: 'pop-yellow', icon: '💰', phase: 9, enabled: true },
  { slug: 'pareo', name: 'Páreo (O "Corre" do Yvens)', description: 'Hipódromo pop: corridas de cavalos ao vivo a cada 3 minutos, sincronizadas para a sala inteira. Até 16 na arquibancada!', family: 'PARTY', minPlayers: 1, maxPlayers: 16, color: 'pop-orange', icon: '🐎', phase: 9, enabled: true },
  { slug: 'cisco', name: 'Cisco (Fazenda do Bruno)', description: 'Corrida de GALINHAS: elas correm, param para ciscar e botam ovos no caminho — aposte na sua e torça! Até 16 no galinheiro.', family: 'PARTY', minPlayers: 1, maxPlayers: 16, color: 'pop-yellow', icon: '🐔', phase: 9, enabled: true },
]
