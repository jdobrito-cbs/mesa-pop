...
export const GAME_CATALOG: GameDef[] = [
  ...
  { slug: 'tio-mario-milionario', name: 'Tio Mário Milionário', description: 'Suba a escada de 16 perguntas até R$ 1 MILHÃO — pare na hora certa ou perca metade! Cartas, universitários, plateia e 3 pulos.', family: 'PUZZLE', minPlayers: 1, maxPlayers: 1, color: 'pop-yellow', icon: '💰', phase: 9, enabled: true },
]
